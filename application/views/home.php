<header class="masthead">
  <div class="container">
    <div class="masthead-heading text-uppercase">Bem vindo ao CELLIJ</div>
    <div class="masthead-subheading">Centro de Estudos em Leitura e Literatura Infantil e Juvenil “Maria Betty
      Coelho Silva”
    </div>
    <a class="btn btn-primary btn-xl text-uppercase js-scroll-trigger" href="#sobre">Saiba mais</a>
  </div>
</header>
<!-- sobre-->
<section class="page-section" id="sobre">
  <div class="container">
    <div class="text-center">
      ...
      <h3 class="section-subheading text-muted">Centro de Estudos em Leitura e Literatura Infantil e Juvenil “Maria
        Betty
        Coelho Silva”</h3>
    </div>
    <div class="row text-justify">
      <div class="offset-md-2 col-md-8">
        <p class="text-muted">O CELLIJ da Faculdade de Ciência e Tecnologia – UNESP Presidente Prudente – criado em
          1995, com o objetivo principal de
          formar leitores a partir do texto literário e de proporcionar um diálogo direto com professores, jovens
          alunos,
          instâncias governamentais responsáveis pela implementação de políticas públicas no campo da Educação, bem
          como com
          discentes do curso de Pedagogia e seus docentes e, posteriormente, com o Programa de Pós-Graduação em
          Educação. O Centro
          atende crianças e jovens da Educação Infantil aos anos finais do Ensino Fundamental. Com vários projetos
          financiados,
          nacional e internacionalmente, o CELLIJ atua com políticas públicas de leitura, pesquisando e comparando
          índices de
          desempenho de estudantes dos anos iniciais do Ensino Fundamental e da Educação Infantil e com ações que
          possam diminuir
          os déficits de aprendizagem desses alunos.</p>
      </div>
    </div>
  </div>
</section>
...
<!-- Clients-->
<section class="page-section bg-light" id="parceiros">
  <div class="text-center">
    <h2 class="section-heading text-uppercase">PARCEIROS</h2>
  </div>
  <div class="py-5">
    <div class="container">
      <div class="row">
...
<section class="page-section" id="contact">
  <div class="container">
    <div class="text-center">
      ...
      <h3 class="section-subheading" style="color: white;">Endereço : Rua Roberto Simonsen 305 - Centro
        Educacional<br>
        Cidade : Presidente Prudente - SP<br>
        E-mail : congressocellij@gmail.com<br>
        Telefone : (18) 3229-5836</h3>
    </div>
